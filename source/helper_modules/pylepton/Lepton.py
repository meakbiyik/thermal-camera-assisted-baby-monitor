...
class Lepton(object):
  ...
  def capture(self, data_buffer = None, log_time = False, debug_print = False, retry_reset = False, return_false_if_error = True):
    ...
    while True:
      ...
      if (self.__capture_buf[20, 0] & 0xFF0F) != 0x1400: # make sure that this is a well-formed frame, should find line 20 here
        if(retry_reset):
